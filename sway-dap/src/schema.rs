...
pub struct ContinueArguments {
    #[doc = " Continue execution for the specified thread (if possible)."]
    #[doc = " If the backend cannot continue on a single thread but will continue on all threads, it "]
    #[doc = " should set the 'allThreadsContinued' attribute in the response to true."]
...
pub struct ContinueResponseBody {
    #[doc = " If true, the 'continue' request has ignored the specified thread and continued all threads "]
    #[doc = " instead."]
    #[doc = " If this attribute is missing a value of 'true' is assumed for backward compatibility."]
    #[serde(skip_serializing_if = "Option::is_none")]
...
#[doc = " the setExceptionsFilter request."]
#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
...
pub struct NextArguments {
    ...
    #[doc = " Execute 'next' for this thread."]
    #[serde(rename = "threadId")]
    pub thread_id: i64,
}
#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
...
pub struct OutputEventBody {
    #[doc = " The output category. If not specified, 'console' is assumed."]
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct ReverseContinueArguments {
    #[doc = " Execute 'reverseContinue' for this thread."]
    #[serde(rename = "threadId")]
    pub thread_id: i64,
}
#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
...
pub struct StepBackArguments {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub granularity: Option<SteppingGranularity>,
    #[doc = " Execute 'stepBack' for this thread."]
    #[serde(rename = "threadId")]
    pub thread_id: i64,
}
#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
...
pub struct StepInArguments {
    ...
    #[doc = " Execute 'stepIn' for this thread."]
    #[serde(rename = "threadId")]
    pub thread_id: i64,
}
#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
...
pub struct StepOutArguments {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub granularity: Option<SteppingGranularity>,
    #[doc = " Execute 'stepOut' for this thread."]
    #[serde(rename = "threadId")]
    pub thread_id: i64,
}
#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
...
pub struct Variable {
    ...
    #[serde(rename = "type")]
    pub type_: Option<String>,
    #[doc = " The variable's value. This can be a multi-line text, e.g. for a function the body of a "]
    #[doc = " function."]
    pub value: String,
...
pub type DebugAdapterProtocol = ::std::collections::BTreeMap<String, serde_json::Value>;
